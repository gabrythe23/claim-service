...
export class ClaimUserMutationController {
  private readonly logger = new Logger(ClaimUserMutationController.name);
  ...
  async updateClaim(
    ...
    await this.service.updateForUser(id, body, userInfo.id.toString());
  }
}
